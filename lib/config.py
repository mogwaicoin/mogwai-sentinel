...
sentinel_cfg = MogwaiConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_mogwaid_proto_version_with_sentinel_ping = 70207


def get_mogwai_conf():
    home = os.environ.get('HOME')

    mogwai_conf = os.path.join(home, ".mogwaicore/mogwai.conf")
    if sys.platform == 'darwin':
        mogwai_conf = os.path.join(home, "Library/Application Support/MogwaiCore/mogwai.conf")

    mogwai_conf = sentinel_cfg.get('mogwai_conf', mogwai_conf)
