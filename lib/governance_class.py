...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to mogwaid "gobject list" output
    ...
    def mogwaid_serialise(self):
        import mogwailib
        return mogwailib.SHIM_serialise_for_mogwaid(self.serialise())
